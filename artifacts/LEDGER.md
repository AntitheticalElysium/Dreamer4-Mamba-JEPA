...
| 2026-09-17 | [closed_loop](experiments/20260917_closed_loop/) | Does the richer-state gain survive repeated prediction? | Complete. **No.** z->z beats persistence 5-10x at every depth; u->u loses to holding still from depth 3. u moves 10x less per step than z, so the one-step gain was largely target easiness. Argues against a joint retrain on this u |
