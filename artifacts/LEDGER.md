...
| 2026-09-17 | [learned_export](experiments/20260917_learned_export/) | Is 192-D too few, or did joint training choose a poor mapping into it? | Complete. Width is not the bottleneck: a matched 192-D learned patch summary reaches 0.764 binary / +0.203 R2 against the current export's 0.618 / -0.086. Relearning from CLS barely helps, so CLS is the lossy step |
